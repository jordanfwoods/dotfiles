...
set __git_tcsh_completion_original_script = ${HOME}/junk/dotfiles/git-completion.bash
set __git_tcsh_completion_script = ${HOME}/junk/dotfiles/git-completion.tcsh.bash
