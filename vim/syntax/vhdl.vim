...
" " operators
" " JQZU made the and/or/etc all red
...
syn keyword	vhdlStatement	and nand or nor xor xnor
syn keyword	vhdlStatement	rol ror sla sll sra srl
syn keyword	vhdlStatement	mod rem abs not
...
"JFW syn match	vhdlComment	"\(^\|\s\)--.*"		contains=vhdlTodo,vhdlFixme,@Spell
...
"JFW syn match	vhdlPreProc	"\(^\|\s\)--\s*rtl_synthesis\s\+\(on\|off\)\s*"
syn match	vhdlPreProc	"--\s*rtl_synthesis\s\+\(on\|off\)\s*"
syn match	vhdlPreProc	"/\*\s*rtl_syn\s\+\(on\|off\)\s*\*/"
"JFW syn match	vhdlPreProc	"\(^\|\s\)--\s*rtl_syn\s\+\(on\|off\)\s*"
syn match	vhdlPreProc	"--\s*rtl_syn\s\+\(on\|off\)\s*"
...
syn match	vhdlPreProc	"--\s*pragma\s\+synthesis_\(on\|off\)\s*"
syn match	vhdlPreProc	"--\s*synopsys\s\+translate_\(on\|off\)\s*"
"JFW syn match	vhdlPreProc	"\(^\|\s\)--\s*synthesis\s\+translate_\(on\|off\)\s*"
"syn match	vhdlPreProc	"\(^\|\s\)--\s*simulation\s\+translate_\(on\|off\)\s*"
"JFW syn match	vhdlPreProc	"\(^\|\s\)--\s*pragma\s\+translate_\(on\|off\)\s*"
"JFW syn match	vhdlPreProc	"\(^\|\s\)--\s*pragma\s\+synthesis_\(on\|off\)\s*"
"JFW syn match	vhdlPreProc	"\(^\|\s\)--\s*synopsys\s\+translate_\(on\|off\)\s*"
...
" JQZU made the <=, etc all orange.
hi def link vhdlOperator    Special
