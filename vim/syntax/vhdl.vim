...
" JFW - These used to be operators
...
" jfw - prefer these as statements - " operators
" jfw - prefer these as statements - syn keyword	vhdlOperator	and nand or nor xor xnor
" jfw - prefer these as statements - syn keyword	vhdlOperator	rol ror sla sll sra srl
" jfw - prefer these as statements - syn keyword	vhdlOperator	mod rem abs not
...
" JFW - Removed block comment, and reduced complexity on comment
...
syn keyword	vhdlPreProc	rising_edge falling_edge
