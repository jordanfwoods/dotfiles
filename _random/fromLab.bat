...
@set SCRIPT=%LOCALBASEDIR%\from.scr
@set LOCAL=%LOCALBASEDIR%\fromLab
@set REMOTE=%REMOTEBASEDIR%/_toPC
...
@if %HELP%==1 @(@echo NOTE: Get all documents recursively from remote dir '%%USERPROFILE%%/%REMOTE%')
@if %HELP%==1 @(@echo       and store locally in '%LOCAL%')
...
::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::
:: Subroutines                                                        ::
:: Note that this should be identical to the subroutines in toLab.bat ::
::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::
